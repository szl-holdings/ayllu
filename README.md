...
| `POST /api/v1/psyche/beat` | five-organ Kawsay pulse. Occupancy MEASURED. Q/F/Y/X MODELED. Presence CONJECTURE |
| `GET /api/v1/psyche/winay` | last autopoietic closure. H/D/Q/F/Y/X MODELED. φ_s UNAVAILABLE. Not presence |
